            ...
            <div class="profile-block">
                <div class="panel text-center">
                    ...
                    <div class="user-heading"><img style="border-radius: 100%;" src="http://cumbrianrun.co.uk/wp-content/uploads/2014/02/default-placeholder-300x300.png" width="250" height="250"><br><br>
                        <% } else {
                            System.out.println("img/" + member.getEmail() + ".jpg");%>
            ...
            <div class="col-md-6">
                ...
                <div class="list-group">
                    ...
                    String email;
                        ...
                        List<Post> posts = (List<Post>) session.getAttribute("myPosts");
                    ...
                    <a href="PostDetailServlet?post_id=<%= post.getId()%>&email=<%=email%>" class="list-group-item">
                        ...
                        <div class="col-xs-4">
                            ...
                            <p class="list-group-item-text">เวลาที่หาย: <%=post.getTime()%>น.</p>
                        </div>
